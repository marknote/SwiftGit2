...
public enum LookupEntry: Codable {
...
public struct GitCredentials: Codable, Identifiable {
    public var id: UUID = UUID()
    public var hostname: String
    public var credentials: LookupEntry


}

public final class LocalGitCredentialsHelper {
    ...
    private func accessLookupEntry(_ entry: LookupEntry) throws
        -> Credentials
    {
        switch entry {
